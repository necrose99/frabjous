...
KEYWORDS="~amd64"
IUSE="bundled-ssl cups custom-cflags gnome gnome-keyring gtk3 kerberos libressl lto neon pic +proprietary-codecs pulseaudio selinux +system-ffmpeg +tcmalloc"
