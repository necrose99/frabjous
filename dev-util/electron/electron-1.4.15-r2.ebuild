...
KEYWORDS="~amd64"
IUSE="bundled-ssl cups custom-cflags gnome gnome-keyring kerberos libressl lto +proprietary-codecs pulseaudio selinux +system-ffmpeg +tcmalloc"
...
src_prepare() {
	...
	epatch "${FILESDIR}/chromium-bundled-jinja.patch"
...
src_install() {
	...
	newins "${S}"/default_app/icon.png electron.png
	make_desktop_entry "electron %u" "Electron" "electron" "Development;GTK;"
}
