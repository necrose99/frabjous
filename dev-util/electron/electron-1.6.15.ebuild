...
KEYWORDS="~amd64"
IUSE="bundled-ssl cups custom-cflags gnome gnome-keyring kerberos libressl lto neon pic +proprietary-codecs pulseaudio selinux +system-ffmpeg +system-icu +tcmalloc"
