...
src_prepare() {
	epatch "${FILESDIR}/0001_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0002_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0003_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0004_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0005_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0006_${PV}-syslibs.patch"
	epatch "${FILESDIR}/0007_${PV}-syslibs.patch"
