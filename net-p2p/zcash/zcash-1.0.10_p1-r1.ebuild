...
UPNPC_PV="2.0"
UPNPC_PKG="miniupnpc-${UPNPC_PV}.tar.gz"
UPNPC_HASH="d434ceb8986efbe199c5ca53f90ed53eab290b1e6d0530b717eb6fa49d61f93b"
UPNPC_URI="http://miniupnp.free.fr/files/${UPNPC_PKG}"
UPNPC_STAMP=".stamp_fetched-miniupnpc-${UPNPC_PKG}.hash"
...
src_prepare() {
	...
	echo "${UPNPC_HASH} ${UPNPC_PKG}" > "${STAMP_DIR}/${UPNPC_STAMP}" || die
	...
	ln -s "${DISTDIR}"/${UPNPC_PKG} "${DEP_SRC}" || die
