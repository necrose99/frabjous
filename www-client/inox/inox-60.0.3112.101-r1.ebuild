...
IUSE="component-build cups custom-cflags gnome-keyring kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg system-libvpx tcmalloc widevine"
...
src_prepare() {
	local PATCHES=(
		...
		"${FILESDIR}/inox-60/0003-disable-autofill-download-manager.patch"
		"${FILESDIR}/inox-60/0004-disable-google-url-tracker.patch"
		"${FILESDIR}/inox-60/0005-disable-default-extensions.patch"
		"${FILESDIR}/inox-60/0006-modify-default-prefs.patch"
		"${FILESDIR}/inox-60/0007-disable-web-resource-service.patch"
		"${FILESDIR}/inox-60/0008-restore-classic-ntp.patch"
		"${FILESDIR}/inox-60/0009-disable-google-ipv6-probes.patch"
		"${FILESDIR}/inox-60/0010-disable-gcm-status-check.patch"
		"${FILESDIR}/inox-60/0011-add-duckduckgo-search-engine.patch"
		"${FILESDIR}/inox-60/0012-branding.patch"
		"${FILESDIR}/inox-60/0013-disable-missing-key-warning.patch"
		"${FILESDIR}/inox-60/0014-disable-translation-lang-fetch.patch"
		"${FILESDIR}/inox-60/0015-disable-update-pings.patch"
		"${FILESDIR}/inox-60/0016-chromium-sandbox-pie.patch"
		"${FILESDIR}/inox-60/0017-disable-new-avatar-menu.patch"
		"${FILESDIR}/inox-60/0018-disable-first-run-behaviour.patch"
		"${FILESDIR}/inox-60/0019-disable-battery-status-service.patch"
		"${FILESDIR}/inox-60/0021-disable-rlz.patch"
		"${FILESDIR}/inox-60/0022-disable-profiler.patch"

		# Waiting upstream approval
		#"${FILESDIR}/inox-60/9999-disable-metrics.patch"
	)
