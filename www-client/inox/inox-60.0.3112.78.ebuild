...
IUSE="component-build cups custom-cflags gnome-keyring +gtk3 kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-libvpx +tcmalloc widevine"
