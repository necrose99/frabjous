...
IUSE="component-build cups custom-cflags gnome-keyring kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu system-libvpx tcmalloc widevine"
...
PATCHES=(
	...
	"${FILESDIR}/inox-61/0001-fix-building-without-safebrowsing.patch"
	"${FILESDIR}/inox-61/0003-disable-autofill-download-manager.patch"
	"${FILESDIR}/inox-61/0004-disable-google-url-tracker.patch"
	"${FILESDIR}/inox-61/0005-disable-default-extensions.patch"
	"${FILESDIR}/inox-61/0006-modify-default-prefs.patch"
	"${FILESDIR}/inox-61/0007-disable-web-resource-service.patch"
	"${FILESDIR}/inox-61/0008-restore-classic-ntp.patch"
	"${FILESDIR}/inox-61/0009-disable-google-ipv6-probes.patch"
	"${FILESDIR}/inox-61/0010-disable-gcm-status-check.patch"
	"${FILESDIR}/inox-61/0011-add-duckduckgo-search-engine.patch"
	"${FILESDIR}/inox-61/0012-branding.patch"
	"${FILESDIR}/inox-61/0013-disable-missing-key-warning.patch"
	"${FILESDIR}/inox-61/0014-disable-translation-lang-fetch.patch"
	"${FILESDIR}/inox-61/0015-disable-update-pings.patch"
	"${FILESDIR}/inox-61/0016-chromium-sandbox-pie.patch"
	"${FILESDIR}/inox-61/0017-disable-new-avatar-menu.patch"
	"${FILESDIR}/inox-61/0018-disable-first-run-behaviour.patch"
	"${FILESDIR}/inox-61/0019-disable-battery-status-service.patch"
	"${FILESDIR}/inox-61/0021-disable-rlz.patch"
	"${FILESDIR}/inox-61/9000-disable-metrics.patch"
	"${FILESDIR}/inox-61/9001-disable-profiler.patch"
	"${FILESDIR}/inox-61/9002-disable-topsites-thumbnails.patch"
	"${FILESDIR}/inox-61/9003-disable-avatar-button.patch"
)
