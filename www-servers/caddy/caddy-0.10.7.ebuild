...
CADDY_PLUGINS=(
	...
	"AUTHZ2 github.com/casbin/casbin 6194d27" #v0.10.0 Apache-2.0 license
	"AUTHZ3 github.com/Knetic/govaluate 89a078c" # MIT license

	"AWSES1 github.com/miquella/caddy-awses d364e01" # Apache-2.0 license
	"AWSES2 github.com/aws/aws-sdk-go e63027a" #v1.10.33 Apache-2.0 license
	...
	"GIT github.com/abiosoft/caddy-git 66a160f" # MIT license
	...
	"GRPC3 github.com/improbable-eng/grpc-web 821be91" # Apache-2.0 license
	"GRPC4 github.com/rs/cors 7af7a1e" #v1.2 MIT license
	"GRPC5 github.com/grpc/grpc-go b3ddf78" #v1.5.2 Apache-2.0 license
	"GRPC6 github.com/google/go-genproto ee236bd" # Apache-2.0 license
	"GRPC7 github.com/golang/net 57efc9c" # BSD license
	...
	"JWT1 github.com/BTBurke/caddy-jwt db0f533" #v2.6.0 MIT license
	...
	"LOGIN5 github.com/golang/crypto 81e9090" # BSD license
	...
	"MINIFY2 github.com/tdewolff/minify 1d4349f" # MIT license
	...
	"MULTIPASS2 github.com/gorilla/csrf 8b1b43b" # BSD license
	...
	"PROMETHEUS2 github.com/prometheus/client_golang 3eb912b" # Apache-2.0 license
	...
	"PROMETHEUS6 github.com/prometheus/common 61f87aa" # Apache-2.0 license
