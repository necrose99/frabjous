...
CADDY_PLUGINS=(
	...
	"AUTHZ3 github.com/Knetic/govaluate beae3c7" # MIT license
	...
	"FILTER github.com/echocat/caddy-filter ce8aa6e" #v0.7.1 MIT license
	"GIT github.com/abiosoft/caddy-git ebb3f0b" # MIT license
	...
	"GRPC5 github.com/grpc/grpc-go b8669c3" #v1.5.1 Apache-2.0 license
	...
	"JWT1 github.com/BTBurke/caddy-jwt 293c4e5" #v2.5.0 MIT license
	...
	"NOBOTS github.com/Xumeiquer/nobots 3a2a5aa" # MIT license

	"PROMETHEUS1 github.com/miekg/caddy-prometheus dc74c64" # Apache-2.0 license
	"PROMETHEUS2 github.com/prometheus/client_golang 94ff84a" # Apache-2.0 license
	...
	"WEBDAV github.com/hacdias/caddy-webdav be65442" # MIT license
)
...
src_prepare() {
	...
	# Avoid panic on QUIC server close
	eapply "${FILESDIR}"/${P}-fix-quic-close.patch
